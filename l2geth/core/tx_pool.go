...
var (
	...
	// ErrInsufficientTonFunds is returned if the total cost of executing a transaction
	// is higher than the balance of the user's account.
	ErrInsufficientTonFunds = errors.New("insufficient ton funds for gas * price + value")
