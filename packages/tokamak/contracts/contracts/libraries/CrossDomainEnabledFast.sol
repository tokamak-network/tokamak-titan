...
contract CrossDomainEnabledFast {
     ...
     * Constructor *
     ***************/
    constructor(address _senderMessenger, address _relayerMessenger) {
     ...
     */
    function getCrossDomainSenderMessenger() internal virtual returns (ICrossDomainMessenger) {
     ...
     * @return The address of the cross-domain messenger contract which should be used.
     */
    function getCrossDomainRelayerMessenger() internal virtual returns (ICrossDomainMessenger) {
