...
const deployFn: DeployFunction = async (hre) => {
  ...
  L1Message = await Factory__L1Message.deploy(L1CrossDomainMessengerFastAddress)
  ...
  await registerAddress(addressManager, 'L1Message', L1Message.address)
  ...
  await registerAddress(addressManager, 'L2Message', L2Message.address)
